...
<template>
  <div class="w-10/12 md:w-7/12 lg:6/12 mx-auto relative py-20 animate-fade-down animate-duration-1000">
    ...
    <div>
      <h2 class="text-center text-3xl font-bold text-red-600">Період 3 (10-12 днів)</h2>
    </div>
    <div class="border-l-2 mt-10">
      <!-- Card 1 -->
      <router-link to="/first_day_expert_program">
      ...
      <!-- Card 2 -->
      <router-link to="/second_day_expert_program">
        <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-red-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
          <!-- Dot Follwing the Left Vertical Line -->
          <div class="w-5 h-5 bg-red-600 absolute -left-10 transform -translate-x-2/4 rounded-full z-10 mt-2 md:mt-0"></div>
          <!-- Line that connecting the box with the vertical line -->
      ...
      <router-link to="/third_day_expert_program">
        <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-red-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
          <!-- Dot Follwing the Left Vertical Line -->
          <div class="w-5 h-5 bg-red-600 absolute -left-10 transform -translate-x-2/4 rounded-full z-10 mt-2 md:mt-0"></div>
          <!-- Line that connecting the box with the vertical line -->
