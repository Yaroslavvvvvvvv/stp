    ...
    <div class="border-l-2 mt-10">
      ...
      <div
        ...
        <!-- Content that showing in the box -->
          <div class="flex-auto">
            <h1 class="text-lg">День 1</h1>
            <router-link to="/beginner_warm_program" class="text-xl font-bold">Orientation and Briefing on Uniliver basics</router-link>
            <h3>Classroom</h3>
          </div>
      ...
      <div
        ...
        <!-- Dot Follwing the Left Vertical Line -->
        <div
            class="w-5 h-5 bg-pink-600 absolute -left-10 transform -translate-x-2/4 rounded-full z-10 mt-2 md:mt-0"></div>
