...
const exercises = [
  ...
  },
  {
    ...
    description: "10-15 вертикальних віджимань від стіни + 10 скручування на прес на підлозі. 15 хвилин роботи."
  },
  {
...
<template>
  <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray- py-6 sm:py-12 animate-fade-down animate-duration-1000">
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      ...
      <div class="mb-8">
        <h2 class="text-center text-3xl font-bold text-amber-500">День 1</h2>
      </div>
