...
const exercises = [
  {
    ...
    description: "Підтягування тотал 50."
  },
  {
    image: "/images/girl_squat.webp",
    description: "Віджимання від підлоги тотал 110."
  },
  {
    image: "/images/girl_deadlift.webp",
    description: "Присідання з підйомом на носки тотал 70."
  },
  {
...
<template>
  <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray- py-6 sm:py-12 animate-fade-down animate-duration-1000">
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      ...
      <div class="mb-8">
        <h2 class="text-center text-3xl font-bold text-amber-400">День 1</h2>
      </div>
