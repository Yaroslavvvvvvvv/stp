...
<template>
  <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray- py-6 sm:py-12 animate-fade-down animate-duration-1000">
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      ...
      <div class="mb-8">
        <h2 class="text-center text-3xl font-bold text-orange-900">День 1</h2>
        <h2 class="text-center text-xl font-bold text-orange-900">Цей день можна дублювати в прямій прогресії
          навантаження тричі поспіль (не кожний день).</h2>
      </div>
