...
const exercises = [
  {
    ...
    description: "Підтягування стоячи ногами на землі 20 повторів."
  },
  {
  ...
  },
  {
    ...
    description: "Повторення минулих пунктів але вдвічі менших цифрах."
  },
  {
    image: "/images/men_pull_up.webp",
  ...
  {
    image: "/images/men_pull_up.webp",
    description: "2 підтягування + 4 віджимання на брусах. Безперервна серія до первинної втоми. Дотримуватись ідеальної техніки " +
        "та високої швидкості виконання."
  },
  {
    image: "/images/boy_push_up.webp",
  ...
  },
  {
    ...
    description: "Загальний збірний тотал австралійські підтягування + віджимання підлоги. 60-120."
  },
  {
...
<template>
  <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray- py-6 sm:py-12 animate-fade-down animate-duration-1000">
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      ...
      <div class="mb-8">
        <h2 class="text-center text-3xl font-bold text-orange-800">День 4</h2>
      </div>
