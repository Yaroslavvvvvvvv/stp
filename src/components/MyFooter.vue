...
<template>
  ...
  <path
      ...
      <hr class="my-6 border-gray-200 border-2 rounded-full sm:mx-auto lg:my-8" />
      <span class="block text-lg font-bold text-gray-200 sm:text-center dark:text-gray-400">© 2024 STP. All Rights Reserved.</span>
    </div>
  </footer>
</template>
