<template>
  <header :style="{ backgroundColor: isAtTop ? 'rgba(3, 7, 18, 1)' : 'rgba(3, 7, 18, 0.9)' }"
    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 animate-fade-down animate-duration-1000"
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        <router-link to="/regulations" class="text-lg font-extrabold leading-6 text-gray-300 hover:text-white">
          Нормативи
        </router-link>
        <router-link to="/workout" class="text-lg font-extrabold leading-6 text-gray-300 hover:text-white">
          Тренування
        </router-link>
      </PopoverGroup>
          ...
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              <router-link to="/regulations"
                           class="-mx-3 block rounded-lg px-3 py-2 text-lg font-extrabold leading-7 text-gray-300 hover:text-white">
                Нормативи
              </router-link>
