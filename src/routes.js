...
const routes = [
    ...
    },
    {
        path: '/sign-up',
        name: 'sign-up',
        component: () => import('./components/SignApp.vue')
    },
    {
        path: '/regulations',
        name: 'regulations',
    ...
    //Expert Second Period
    {
        path: '/expert_second_period',
        name: 'expert second period',
        component: () => import('./views/kits/expert_basic_training/ExpertSecondPeriod.vue')
    },
    {
        path: '/expert_day_first_program',
        name: 'expert day first program',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/ExpertDayFirstProgram.vue')
    },
    {
        path: '/expert_day_second_program',
        name: 'expert day second program',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/ExpertDaySecondProgram.vue')
    },
    {
        path: '/expert_day_third_program',
        name: 'expert day third program',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/ExpertDayThirdProgram.vue')
    },
    {
        path: '/expert_day_fourth_program',
        name: 'expert day fourth program',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/ExpertDayFourthProgram.vue')
    },
    {
        path: '/expert_second_full_period',
        name: 'expert second full period',
        component: () => import('./views/kits/expert_full_training/ExpertSecondFullPeriod.vue')
    },
    {
        path: '/expert_day_first_full_program',
        name: 'expert day first full program',
        component: () => import('./views/kits/expert_full_training/expert_full_program/ExpertDayFirstFullProgram.vue')
    },
    {
        path: '/expert_day_second_full_program',
        name: 'expert day second full program',
        component: () => import('./views/kits/expert_full_training/expert_full_program/ExpertDaySecondFullProgram.vue')
    },
    {
        path: '/expert_day_third_full_program',
        name: 'expert day third full program',
        component: () => import('./views/kits/expert_full_training/expert_full_program/ExpertDayThirdFullProgram.vue')
    },
    {
        path: '/expert_day_fourth_full_program',
    ...
    //Expert Fourth Period
    {
        path: '/expert_fourth_period',
        name: 'expert fourth period',
        component: () => import('./views/kits/expert_basic_training/ExpertFourthPeriod.vue')
    },
    {
        path: '/first_day_program_expert',
        name: 'first day program expert',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/FirstDayProgramExpert.vue')
    },
    {
        path: '/second_day_program_expert',
        name: 'second day program expert',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/SecondDayProgramExpert.vue')
    },
    {
        path: '/third_day_program_expert',
        name: 'third day program expert',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/ThirdDayProgramExpert.vue')
    },
    {
        path: '/fourth_day_program_expert',
        name: 'fourth day program expert',
        component: () => import('./views/kits/expert_basic_training/expert_basic_program/FourthDayProgramExpert.vue')
    },
    {
        path: '/expert_fourth_full_period',
        name: 'expert fourth full period',
        component: () => import('./views/kits/expert_full_training/ExpertFourthFullPeriod.vue')
    },
    {
        path: '/first_day_full_program_expert',
        name: 'first day full program expert',
        component: () => import('./views/kits/expert_full_training/expert_full_program/FirstDayFullProgramExpert.vue')
    },
    {
        path: '/second_day_full_program_expert',
        name: 'second day full program expert',
        component: () => import('./views/kits/expert_full_training/expert_full_program/SecondDayFullProgramExpert.vue')
    },
    {
        path: '/third_day_full_program_expert',
...
router.beforeEach((to, from, next) => {
    // Прокручиваем страницу вверх при переходе на новый маршрут
    window.scrollTo(0, 0);
    next();
});
